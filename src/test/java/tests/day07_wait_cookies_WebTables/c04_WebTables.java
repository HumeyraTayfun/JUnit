...
public class c04_WebTables extends TestBase {
    ...
    public void webTableTesti(){
        ...
        List<String> satirListesiStr = ReusableMethods.stringlisteDönüştür(satirElementleriListesi);
        ...
        List<String> baslikListesiStr = ReusableMethods.stringlisteDönüştür(baslikElementleriList);
